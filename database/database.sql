CREATE DATABASE  IF NOT EXISTS `php_mysql_app_01` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `php_mysql_app_01`;
-- MySQL dump 10.13  Distrib 8.0.11, for Win64 (x86_64)
--
-- Host: localhost    Database: php_mysql_app_01
-- ------------------------------------------------------
...
CREATE TABLE `movie` (
  ...
  CONSTRAINT `fk_movie_category` FOREIGN KEY (`category_name`) REFERENCES `category` (`name`)
...
-- Dump completed on 2020-02-16 23:26:00
